...
public class Constants {
    ...
    public static final double X_RECT = -0.5;
    public static final double Y_RECT = -0.5;
    public static final double WIDTH_RECT = 1;
    public static final double HEIGHT_RECT = 1;
